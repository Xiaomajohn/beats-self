...
import (
	...
	metricbeat "github.com/elastic/beats/v7/auditmetricbeat/metricbeat/scripts/mage"
	...
	//mage:import
	_ "github.com/elastic/beats/v7/auditmetricbeat/metricbeat/scripts/mage/target/metricset"
)
...
func MockedTests(ctx context.Context) error {
	...
	params.ExtraFlags = []string{"github.com/elastic/beats/v7/auditmetricbeat/metricbeat/mb/testing/data/."}
